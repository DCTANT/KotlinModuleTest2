package com.tstdct.testkotlin.e_utils;
...
import com.tstdct.testkotlin.z_base.IBase;
...
public class EditTextUtil {
	...
	public static <T extends IBase, C extends EditText> void limitWord(final C editText, final T activity, final String promptWord, final int limitWords) {
		...
		editText.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				if (s.length() > limitWords) {
					...
					if (!isTip[0]) {
						isTip[0] = true;
						activity.showErrorSmallSize(promptWord);
//						Toast.makeText(context, "意见反馈最多200字", Toast.LENGTH_SHORT).show();
	...
	public static <C extends TextView,T extends IBase> boolean isEmpty(C editText, T activity, String emptyString){
		if(editText.getText().toString().trim().length()==0){
			activity.showErrorSmallSize(emptyString);
			return true;
		}else{
			return false;
		}
	...
	public static <C extends TextView,T extends IBase> boolean isEmpty(C editText){
		if(editText.getText().toString().trim().length()==0){
			return true;
		}else{
			return false;
	...
	public static <T extends IBase, C extends EditText> void limitDecimal(final C editText, final T activity, final String promptWord, final int limitDecimalLength) {
		final boolean[] isTip = {false};
		editText.addTextChangedListener(new TextWatcher() {
			@Override
			public void beforeTextChanged(CharSequence s, int start, int count, int after) {
...
//						Toast.makeText(context, "意见反馈最多200字", Toast.LENGTH_SHORT).show();
	...
	public static <T extends IBase, C extends EditText> void limitInputName(final C editText, final T activity, final String promptWord) {
		final boolean[] isTip = {false};
		editText.addTextChangedListener(new TextWatcher() {
			@Override
			public void beforeTextChanged(CharSequence s, int start, int count, int after) {
...
//						inputChar[i]=' ';
	...
	public static <T extends IBase, C extends EditText> void setOnWordLengthListener(C editText, final int length, final OnWordLengthListener onWordLengthListener) {
		final boolean[] isTip = {false};
		editText.addTextChangedListener(new TextWatcher() {
			@Override
			public void beforeTextChanged(CharSequence s, int start, int count, int after) {
    ...
    public static <T extends IBase, C extends EditText> void setOnEditTextNotEmptyListener(C editText, final OnEditTextNotEmptyListener onEditTextNotEmptyListener) {
        editText.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
    ...
    public static <T extends IBase, C extends EditText> void setOnEditTextEmptyListener(C editText, final OnEditTextEmptyListener onEditTextEmptyListener) {
        editText.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
	 ...
	 */
	public static <T extends IBase, C extends TextView> boolean isEmptyEditTextList(ArrayList<C> editTextList, ArrayList<String> emptyWordList, T activity){
    	for(int i=0;i<editTextList.size();i++){
    		if(EditTextUtil.isEmpty(editTextList.get(i),activity,emptyWordList.get(i))){
    			return true;
			}
		}
		return false;
	...
	public static <T extends IBase, C extends TextView> void setOnEditTextLengthChangeListener(C editText, final OnEditTextLengthChangeListener onEditTextLengthChangeListener) {
		editText.addTextChangedListener(new TextWatcher() {
			@Override
			public void beforeTextChanged(CharSequence s, int start, int count, int after) {
