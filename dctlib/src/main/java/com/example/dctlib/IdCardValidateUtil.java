...
public class IdCardValidateUtil {
	...
	private static IdCardValidateUtil instance;
	private IdCardValidateUtil()
	{
		
	}
	public static IdCardValidateUtil getInstance()
	{
		if(instance == null) instance = new IdCardValidateUtil();
		return instance;
	}
     ...
     */
    public boolean isIDCard(String certNo){
    ...
    public static void main(String[] args) {    
         boolean mark = IdCardValidateUtil.getInstance().isIDCard("130621198402136294");    
