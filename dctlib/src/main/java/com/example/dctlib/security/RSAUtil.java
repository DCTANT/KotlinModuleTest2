package com.example.dctlib.security;
...
/**
 * Created by Dechert on 4/24/2018.
...
public class RSAUtil {
	...
	public static final String RSA_ALGORITHM_Cipher = "RSA/ECB/PKCS1Padding";//选择这个和下面这个都可以
//	public static final String RSA_ALGORITHM_Cipher = "RSA/NONE/PKCS1Padding";
	...
	public static Map<String, String> createKeys(int keySize){
		...
		try{
			kpg = KeyPairGenerator.getInstance(RSA_ALGORITHM_Key);
		}catch(NoSuchAlgorithmException e){
			throw new IllegalArgumentException("No such algorithm-->[" + RSA_ALGORITHM_Key + "]");
		}
